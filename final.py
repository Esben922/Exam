...
df = pd.read_csv('kiva_loans_part_0.csv', encoding='utf-8', on_bad_lines='skip')
df1 = pd.read_csv('kiva_loans_part_1.csv', encoding='utf-8', on_bad_lines='skip')
df2 = pd.read_csv('kiva_loans_part_2.csv', encoding='utf-8', on_bad_lines='skip')
