...
with st.expander("What's this app?"):
    st.markdown("""
    This app is a KIVA loan amount predicter for loans in Kenya!
    """)
...
with col2:
    term_in_months = st.number_input('term_in_months', min_value=0, max_value=10, value=1)
    lender_count = st.number_input('lender_count', min_value=0, max_value=10, value=1)
